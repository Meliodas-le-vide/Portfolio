...
import { FaLightbulb, FaCheckSquare } from "react-icons/fa";
import { MdLanguage } from "react-icons/md";
import { GiMuscleUp } from "react-icons/gi";
import { IoFootball } from "react-icons/io5";
import { FaGamepad, FaTv, FaBook, FaDrum } from "react-icons/fa";
    ...
    <>
      ...
      >
        <motion.h1
          ...
          className="mt-10 text-4xl font-extrabold tracking-tight text-center text-white mb-12 text-4xl font-extrabold tracking-tight text-white sm:text-5xl bg-clip-text text-transparent bg-gradient-to-r from-white via-slate-200 to-slate-400"
        >
          À propos de moi
        </motion.h1>
          ...
          >
            ...
            <div className="w-full bg-slate-950/40 backdrop-blur-lg rounded-2xl p-6 border border-slate-800/60 shadow-2xl">
              ...
              <p className="text-slate-300 text-sm md:text-base leading-relaxed max-w-2xl">
                ...
                numériques fluides. Je conçois des applications web de bout en
                bout, en combinant la logique d'une
                <span className="text-emerald-400 font-semibold">
                  {" "}
                  architecture back-end robuste
                </span>{" "}
                et l&apos;interactivité d&apos;une
                <span className="text-cyan-400 font-semibold">
                  {" "}
                  interface utilisateur intuitive
                </span>
                . Mon objectif : transformer des idées complexes en solutions
                performantes, évolutives et centrées sur l&apos;utilisateur.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="lg:col-span-7">
            ...
            <div className="space-y-6">
              {categories.map((category) => (
                <div
                  key={category.id}
                  className="bg-slate-900/20 p-4 rounded-xl border border-slate-800/40"
                >
      ...
      >
        ...
        <motion.div variants={itemVariants} className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-slate-950/40 rounded-xl p-5 border border-slate-800/60 hover:border-emerald-500/30 transition-all duration-300">
              ...
              <ul className="text-slate-300 space-y-4 text-sm">
                <li className="flex items-start gap-3">
                  <span className="bg-emerald-500/10 text-blue-400 font-bold px-2 py-0.5 rounded text-xs mt-0.5">
                    2025 - 2026
                  </span>
                  <div>
                    <p className="font-medium text-white">WeCode</p>
                    <p className="text-xs text-slate-400">
                      Formation developpeur Fullsatck
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-white">Institut Cerco</p>
                    <p className="text-xs text-slate-400">License 2</p>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-white">Institut Cerco</p>
                    <p className="text-xs text-slate-400">License 1</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="bg-emerald-500/10 text-blue-400 font-bold px-2 py-0.5 rounded text-xs mt-0.5">
                  ...
                  <div>
                    <p className="font-medium text-white">
                      {" "}
                      Lycee Moderne Yopougon Andokoi
                    </p>
                    <p className="text-xs text-slate-400">BAC Scientifique</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-slate-950/40 rounded-xl p-5 border border-slate-800/60 hover:border-emerald-500/30 transition-all duration-300">
              <h3 className="text-lg font-semibold mb-4 text-blue-400 flex items-center gap-2">
                <IoFootball className="w-5 h-5 text-emerald-400 animate-pulse" />
                Centres d&apos;intérêt
              </h3>
              <ul className="text-slate-300 space-y-3 text-sm">
                <li className="flex items-center gap-3 hover:text-white transition-colors duration-200">
                  <IoFootball className="text-blue-400 w-4 h-4" />
                  <span>Football</span>
                </li>
                <li className="flex items-center gap-3 hover:text-white transition-colors duration-200">
                  <FaGamepad className="text-blue-400 w-4 h-4" />
                  <span>Jeux vidéo</span>
                </li>
                <li className="flex items-center gap-3 hover:text-white transition-colors duration-200">
                  <FaTv className="text-blue-400 w-4 h-4" />
                  <span>Animés</span>
                </li>
                <li className="flex items-center gap-3 hover:text-white transition-colors duration-200">
                ...
                <li className="flex items-center gap-3 hover:text-white transition-colors duration-200">
                  <FaDrum className="text-blue-400 w-4 h-4" />
                  <span>Musique (Batterie)</span>
                </li>
              </ul>
            </div>
              ...
              <ul className="text-slate-300 space-y-4 text-sm">
                ...
                <li className="space-y-1">
                  <div className="flex justify-between text-xs">
                    <span>
                      Français <b className="text-white">(Courant / B2)</b>
                    </span>
                    <span className="text-slate-400">85%</span>
                  </div>
                  <div className="w-full bg-slate-800 h-1.5 rounded-full overflow-hidden">
                    {/* w-[85%] remplit la barre à 85% */}
                ...
                <li className="space-y-1">
                  <div className="flex justify-between text-xs">
                    <span>
                      Anglais <b className="text-white">(Intermédiaire / B1)</b>
                    </span>
                    <span className="text-slate-400">60%</span>
                  </div>
                  <div className="w-full bg-slate-800 h-1.5 rounded-full overflow-hidden">
                    {/* w-[60%] remplit la barre à 60% */}
